...
- Create repo: https://github.com/YOUR_USERNAME/gchat-messages
- Generate PAT: https://github.com/settings/tokens (scopes: repo)
- Config: Open app, enter REPO_NAME and TOKEN in prompt/localStorage
